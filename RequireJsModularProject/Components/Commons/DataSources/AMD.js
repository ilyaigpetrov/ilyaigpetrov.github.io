...
define(
  ...
  function (
    ...
    function Collection( list ) {
      ...
      DataSource.apply( this, arguments ); // Magically this provides prototypical inheritance for `this`.
    ...
    function idToObjectMap( identifiedList ) {
      ...
      this.update = function( identifiedItem ) {
        this.map[identifiedItem.id] = identifiedItem;
        $(this).trigger( 'change' );
      }
